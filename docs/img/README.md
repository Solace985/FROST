...
The root `README.md` references three screenshots of the FROST tool. Drop these
PNGs here (same filenames) and they render automatically on GitHub:

- **`frost-home.png`** — the demonstrator home page (the "Run your own analysis" hero + context band).
- **`frost-triage.png`** — a run's **Research triage result** panel (decision banner + gauge + metrics).
